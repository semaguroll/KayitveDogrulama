<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="KayitveDogrulama.Home" %>
                ...
                <div class="widget_wrap">
                    ...
                    <div class="widget_content">
                        <div action="#" method="post" class="form_container">
                            ...
                            <div class="form_grid_12">
                               <%--<a href="Result.aspx"> <asp:Button runat="server" id="btnSignUp" Text="Kayıt Ol"  OnClick="btnSignUp_Click" /> </a>--%>
                            </div>
                        </div>
                    </div>
                </div>
